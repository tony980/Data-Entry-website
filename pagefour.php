...
<div class="collapse navbar-collapse" id="collapseExample">
  <div class="card card-body">
    <p style="color:#6495ED;"><i><b>1.Once you have filled data on the available space,click "submit data" which will capture your data.<br>
   2. Any additional information can be inserted on new row after submission of the first data.<br>
   3. Once you have submitted all the data, proceed to the next page.<br>
   4. Make sure to submit data before proceeding to next page.</b></i></p>
  </div>
</div>
...
<!-- Editable table -->
<div class="card">
  <h7 class="card-header text-center font-weight-bold text-uppercase py-4"  style="color:#6495ED;"><b> NUMBER OF STUDENTS  GRADUATED BY PROGRAMME</b></h7>
  <div class="card-body">
      ...
      <table class="table table-bordered table-responsive-md table-striped text-center bg-light"  style="color:#6495ED;">
        ...
        <thead>
          <tr>
            ...
            <th  width="10%" class="text-center"><b>S/NO</th>
            <th  width="26%" class="text-center"><b>PROGRAMME/COURSE</b></th>
             <th  width="14%" class="text-center"><b>DURATION</b></th>
            <th   width="14%" class="text-center"><b>CODE(office-Use)</b></th>
            <th  width="10%" class="text-center"><b>MALE</b></th>
             <th  width="10%" class="text-center"><b>FEMALE</b></th>
            <th width="10%"   class="text-center"><b>YEAR</b></th>
        ...
        <tbody>
          <tr>
            ...
            <td class="pt-3-half" contenteditable="false"><input type="text" class=" form-control input-md pt-3-half" name="S/NO"  placeholder="S/No." required=""  style="color:#6495ED;"></td>
            <td class="pt-3-half" contenteditable="false"><select name="COURSE" id="Institution Type" class=" form-control input-lg pt-3-half"  style="color:#6495ED;"autocomplete="off" required="">
...
<option>860013  Aircraft Accident Investigation</option>
            ...
            <td class="pt-3-half" contenteditable="false"><select name="DURATION" id="Institution Type" class=" form-control input-lg pt-3-half"  style="color:#6495ED;" autocomplete="off" required="">
            ...
            <td class="pt-3-half" contenteditable="false"  ><select name="CODE" id="Institution Type" class=" form-control input-lg pt-3-half"  style="color:#6495ED;" autocomplete="off" required="">
...
<option>990099</option>
            ...
            <td class="pt-3-half" contenteditable="false"><input type="text" class=" form-control input-md pt-3-half" name="MALE"  placeholder="NO." required=""  style="color:#6495ED;"></td>
           <td class="pt-3-half" contenteditable="false"  > <input type="text" class=" form-control input-md pt-3-half" name="FEMALE"  placeholder="NO." required=""  style="color:#6495ED;"></td>
           <td class="pt-3-half" contenteditable="false"  ><input type="text" class=" form-control input-md pt-3-half" name="YEAR"  placeholder="Year" required=""  style="color:#6495ED;"> </td>
...
<td class="pt-3-half" contenteditable="false"><input type="text" class=" form-control input-lg pt-3-half" name="ownership"  placeholder="YEAR" value="<?php echo $type;?>"  ></td>
          </tr>
       ...
       <input type="submit" value="submit data"  class="btn btn-outline-primary" /><br>
    </div>
  </div>
</div>
...
<div class="form-group">        
      <div class="col-sm-offset-2 col-sm-10">
        <a href="pagefive.php"><button type="button" class="btn btn-primary"><b>PROCEED TO THE NEXT PAGE</b></button></a>
      </div>
    </div>
<!-- Footer -->
