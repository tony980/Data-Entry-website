...
<script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
 ...
 // needs to be before anything else on page to use $_SESSION
   ...
   $sql = "SELECT `serial number`, `programme`, `Duration`, `Code`, `male`, `female`, `year`, `institution`, `date`, `ownership` FROM `students graduated` WHERE date Between '{$_SESSION['begin1']}' and  '{$_SESSION['end1']}'  order by date ";
      ...
      <h3 align="center" style="color:#5dade2;">STUDENTS GRADUATED</h3><br /><br /> 
       ...
       <table border="1;" class="table table-bordered table-responsive-md table-striped text-center  bg-light" style="align:left;">  
           <tr   >  
                ...
                <th  width="18%" class="text-center bg-light"><b>PROGRAMME</b></th>  
