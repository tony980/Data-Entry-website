...
<div class="img-container">
     <img src="logo3.jpg" height="70" width="100" alt='missing' s > </div>
      <figcaption style="color: #6495ED;"><b>REPUBLIC OF KENYA <br>MINISTRY OF LABOUR & SOCIAL PROTECTION
...
<br>
  ...
  <fieldset class="scheduler-border">
    <legend align="center" class="scheduler-border    bg-light"  style="text-align: center;color: #6495ED;"><h6><b>STUDENTS ADMITTED QUERY</b></h6></legend>
...
<div class="col-lg-12">
  <div class="row">
    <div class="col-lg-1">
        ...
        <label class="control-label col-xs-2" for="START"   style="color: #6495ED;">STARTDATE:</label>
    </div>
    <div class="col-lg-3">
        <input type="date" class="form-control"  name="txtstartdate" required=""  style="color: #6495ED;" /> 
    </div>


     <div class="col-lg-1">
        <label class="control-label col-xs-2" for="END DATE"  style="color: #6495ED;">END DATE:</label>
    </div>
    <div class="col-lg-3">
        <input type="date" class="form-control"  name="txtenddate" required="" style="color: #6495ED;"/> 
    </div>

    <div class="col-lg-1">
    	<button type="submit"     class="btn btn-primary"  name="search"  ><b> SUBMIT QUERY</b></button>
    	</div>
</div>
</div>
</div>
...
<div class="col-lg-12">
  <div class="row">
    <div class="col-lg-1">
        <label class="control-label col-xs-2" for="Designation"  style="color: #6495ED;">YEAR:</label>
    </div>
    <div class="col-lg-3">
        <input type="text" class="form-control"  name="year"  placeholder="Year" required=""  style="color: #6495ED;"/> 
    </div>
      <div class="col-lg-1">
    	 <button type="submit"     class="btn btn-primary"  name="search"   > <b> SUBMIT QUERY</b></button>
    	</div>
...
<form action="result9.php" method="post">
<b>
...
<div class="col-lg-12">
  <div class="row">
    <div class="col-lg-1">
        <label class="control-label col-xs-2" for="Designation"   style="color: #6495ED;">COURSE:</label>

        
    </div>
    <div class="col-lg-3">
<select name="unit"  class=" form-control input-lg pt-3-half"  autocomplete="off" required=""    style="color: #6495ED;">
...
<form method="post" action="result2.php">
  ...
  <fieldset class="scheduler-border">
    <legend align="center" class="scheduler-border  bg-light"  style="color: #6495ED; text-align: center;" ><h6><b>STUDENTS GRADUATED QUERY</b></h6></legend>
...
<div class="col-lg-12">
  <div class="row">
    <div class="col-lg-1">
        ...
        <label class="control-label col-xs-2" for="START DATE"  style="color: #6495ED;">STARTDATE:</label>
    </div>
    <div class="col-lg-3">
        <input type="date" class="form-control"  name="txtstartdate" required=""  style="color: #6495ED;" /> 
    </div>
...
<div class="col-lg-12">
  <div class="row">
    ...
    <div class="col-lg-3">
        <input type="text" class="form-control" id="YEAR" placeholder="Year" name="YEAR" required=""   style="color: #6495ED;"> 
    </div>
      <div class="col-lg-1">
    	 <button type="submit"     class="btn btn-primary"  name="search"   > <b> SUBMIT QUERY </b></button>
    	</div>
...
<div class="col-lg-12">
  <div class="row">
    <div class="col-lg-1">
        <label class="control-label col-xs-2"  style="color: #6495ED;">COURSE:</label>
...
<form method="post" action="result5.php">
  ...
  <fieldset class="scheduler-border">
    <legend align="center" class="scheduler-border   bg-light"  style="color:#6495ED; text-align: center;" ><h6><b>ACADEMIC STAFF QUERY</b></h6></legend>
...
<B>
<form action="result6.php"  method="POST">
		<div class="form-group">
<div class="col-lg-12">
  <div class="row">
    <div class="col-lg-1">
...
<div class="col-lg-12">
  <div class="row">
    <div class="col-lg-1">
        <label class="control-label col-xs-2"  style="color: #6495ED;" >SKILL LEVEL:</label>
    </div>
    <div class="col-lg-3">
        <select name="skill"  class=" form-control input-lg pt-3-half" style="color: #6495ED;" autocomplete="off" required="">
              <OPTION>PHD</OPTION>
