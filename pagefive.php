...
<div class="collapse navbar-collapse" id="collapseExample">
  <div class="card card-body">
   ...
   4. Make sure to submit data before returning to Homepage.</b></i></p>
  </div>
</div>
...
<!-- Editable table -->
<div class="card">
  <h7 class="card-header text-center font-weight-bold text-uppercase py-4"  style="color:#6495ED;"><b> NUMBER OF ACADEMIC STAFF</b></h7>
  <div class="card-body">
    <div id="table" class="table-editable">
      ...
      <table class="table table-bordered table-responsive-md table-striped text-center   bg-light" style="color:#6495ED;">
        ...
        <thead>
          <tr>
            <th   width="10%" class="text-center" style="text-align: center;"><b>S/NO</b></th>
            <th  width="10%" class="text-center"><b>SKILL</b></th>
            <th  width="10%" class="text-center"><b>CODE(for office use)</b></th>
            <th  width="9%" class="text-center"><b>MALE</b></th>
             <th  width="9%" class="text-center"><b>FEMALE</b></th>
        ...
        <tbody>
          <tr>
            <td class="pt-3-half" contenteditable="false"><input type="text" class=" form-control input-lg pt-3-half" name="S/NO"  placeholder="S/No." required=""  style="color:#6495ED;"></td>
            <td class="pt-3-half" contenteditable="false"><select name="type" id="Institution Type" class=" form-control input-lg pt-3-half" style="color:#6495ED;text-align: center;" autocomplete="off" required="">
              <OPTION>PHD</OPTION>
            ...
            <td class="pt-3-half" contenteditable="false"  ><select name="CODE" id="Institution Type" class=" form-control input-lg pt-3-half" style="color:#6495ED;text-align: center;" autocomplete="off" required="">
...
<option></option>
            ...
            <td class="pt-3-half" contenteditable="false"><input type="text" class=" form-control input-lg pt-3-half" name="MALE"  placeholder="NO." required=""  style="color:#6495ED;"></td>
           <td class="pt-3-half" contenteditable="false"  > <input type="text" class=" form-control input-lg pt-3-half" name="FEMALE"  placeholder="NO." required=""  style="color:#6495ED;"></td>
            <td class="pt-3-half" contenteditable="false"  ><input type="text" class=" form-control input-lg pt-3-half" name="YEAR"  placeholder="Year" required=""  style="color:#6495ED;"> </td>
           ...
           <td class="pt-3-half" contenteditable="false"><input type="text" class=" form-control input-lg pt-3-half" name="ownership"  placeholder="ownership" value="<?php echo $type;?>"  ></td>
...
<div class="form-group">        
      <div class="col-sm-offset-2 col-sm-10">
        <a href="pageone.php"><button type="button" class="btn btn-primary"><b>RETURN TO HOMEPAGE</b></button></a>
      </div>
    </div>
  </form>
<p  align="center"  style="color: #6495ED;"><B><u>THANK YOU FOR PARTICIPATING IN THE EXERCISE </u> <i class="fa fa-thumbs-o-up"   style="font-size:26px;"></i></B></p>
