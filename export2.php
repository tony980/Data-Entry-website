...
<script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
           ...
           <title   style="color: RED;">Students Admitted</title>  
 ...
 // needs to be before anything else on page to use $_SESSION
   ...
   $sql = "SELECT `ownership`, `date`, `institution`, `serial number`, `programme`, `programme code`, `male`, `female`, `year` FROM `students admitted` WHERE date Between '{$_SESSION['begin']}' and  '{$_SESSION['finish']}'  order by date ";
 ...
 {  
      ...
      $content = '';  
      $content .= '  
      <h3 align="center" style="color:#5dade2;">STUDENTS ADMITTED</h3><br /><br />  
 ...
 ?>  
           ...
           <div class="container" style="width:700px;">  
                <h3 align="center" style="color: #6495ED;">STUDENTS ADMITTED</h3><br />  
