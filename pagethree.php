...
<!-- Editable table -->
<div class="card">
  <h7 class="card-header text-center font-weight-bold text-uppercase py-4"  style="color:#6495ED;"><b>NUMBER OF STUDENTS ADMITTED BY PROGRAMME </b></h7>
  <div class="card-body">
      ...
      <table class="table table-bordered table-responsive-md table-striped text-center  bg-light" style="color:#6495ED;">
        ...
        <thead>
          <tr>
            ...
            <th width="10%" class="text-center"><b>S/NO.</b></th>

            <th width="25%" class="text-center"><b>PROGRAMME/COURSE</b></th>
            <th width="15%" class="text-center"><b>CODE(for office use)</b></th>
        ...
        <tbody>
          <tr>
            ...
            <td class="pt-3-half" contenteditable="false"> <select name="class_type" id="Institution Type" class=" form-control input-lg pt-3-half" style="color:#6495ED;" autocomplete="off" required="">
...
<td class="pt-3-half" contenteditable="false"><input type="text" class=" form-control input-lg pt-3-half" name="ownership"  placeholder="YEAR" value="<?php echo $type;?>"  ></td>
      ...
      <input type="submit" value="submit data"  class="btn btn-outline-primary" />
    </div>
  </div>
</div>
...
<div class="form-group">        
      <div class="col-sm-offset-2 col-sm-10">
        ...
        <a href="pagefour.php"><button type="button" class="btn btn-primary"> <b>PROCEED TO NEXT THE  PAGE</b></button></a>
