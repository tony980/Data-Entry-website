...
<script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
 ...
 // needs to be before anything else on page to use $_SESSION
   ...
   $sql = "SELECT `serial number`, `skill level`, `programme code`, `male`, `female`, `year`, `institution`, `date`, `ownership` FROM `academic staff` WHERE date  Between '{$_SESSION['begin2']}' and  '{$_SESSION['end2']}'  order by date ";
